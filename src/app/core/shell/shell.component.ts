  ...
  ngOnInit() {
   ...
   if (!localStorage.getItem('MidasTour')&&(this.isDesktop)){
    ...
    this.tourService.initialize([
      ...
      content: 'Nút này dùng để truy cập vào màn hình quản lý thông tin của khách hàng, đại lý và nhân viên nội bộ.',
      title: 'NÚT "THÔNG TIN KHÁCH HÀNG/ ĐẠI LÝ/ NHÂN VIÊN"',

    },
    {
      anchorId: 'toolbar-2-2',
      content: 'Nút này dùng xem danh sách các khoản phải thu/ phỉ chi của khách hàng và đại lý và danh sách tài khoản của nhân viên nội bộ',
      title: 'NÚT "DANH SÁCH TÀI KHOẢN "',
    },
    
    {
      anchorId: 'toolbar-2-3',
      content: 'Nút này dùng xem danh sách các đã được thực hiện, các giao dịch đáo hạn thẻ, giao dịch thu/chi cho các giao dịch và danh sách booking của đại lý',
    ...
    {
      anchorId: 'id6',
      content: 'Đây là khu vực tim kiếm thông tin khách hàng/ thẻ của khách hàng / CMND ... để bắt đầu thực hiện "giao dịch lẻ".',
