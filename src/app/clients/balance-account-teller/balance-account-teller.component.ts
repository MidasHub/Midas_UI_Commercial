...
export class BalanceAccountTellerComponent implements OnInit {
  ...
  sortData(sort: any) {
    this.accountFilter = this.accountFilter.sort((a, b) => {
      ...
      switch (sort.active) {
        case 'tellerSourceName': return this.compare(a.tellerSourceName, b.tellerSourceName, isAsc);
        case 'accountNo': return this.compare(a.accountNo, b.accountNo, isAsc);
        case 'sourceInfo': return this.compare(a.sourceInfo, b.sourceInfo, isAsc);
