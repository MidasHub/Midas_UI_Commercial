...
export class SingleRowComponent implements OnInit {
    ...
    addDialogRef.afterClosed().subscribe((response: any) => {
      if (response.data) {
        ...
        dateTransformColumns.forEach((column) => {
          response.data.value[column] = this.datePipe.transform(
        ...
        this.clientsService
          .addClientDatatableEntry(this.clientId, this.datatableName, dataTableEntryObject)
          .subscribe(() => {
  ...
  edit() {
    ...
    editDialogRef.afterClosed().subscribe((response: any) => {
      if (response.data) {
        ...
        dataTableEntryObject = { ...response.data.value, ...dataTableEntryObject };
        this.clientsService
          .editClientDatatableEntry(this.clientId, this.datatableName, dataTableEntryObject)
          .subscribe(() => {
            this.clientsService.getClientDatatable(this.clientId, this.datatableName).subscribe((dataObject: any) => {
              this.dataObject = dataObject;
            });
  ...
  delete() {
    ...
    deleteDataTableDialogRef.afterClosed().subscribe((response: any) => {
      if (response.delete) {
        this.clientsService.deleteDatatableContent(this.clientId, this.datatableName).subscribe(() => {
          this.clientsService.getClientDatatable(this.clientId, this.datatableName).subscribe((dataObject: any) => {
            this.dataObject = dataObject;
          });
        });
