...
export class IdentitiesTabComponent {
  ...
  /** Identifiers Table */
  @ViewChild('identifiersTable', { static: true }) identifiersTable: MatTable<Element> | any;
  @ViewChild('identifiersTableOther', { static: true }) identifiersTableOther: MatTable<Element> | any;
  ...
  constructor(
    ...
    this.route.data.subscribe((data: { clientIdentities: any; clientIdentifierTemplate: any }| Data) => {
