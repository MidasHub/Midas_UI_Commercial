 ...
 */
@Injectable()
export class IcSavingsAccountActionsResolver implements Resolve<Object> {
  ...
  resolve(route: ActivatedRouteSnapshot): Observable<any> {
    ...
    switch (actionName) {
      ...
      case 'Withdrawal':
      case 'Deposit':
        return this.savingsService.getIcSavingsTransactionTemplateResource(savingAccountId);
      case 'Close':
        return forkJoin([
