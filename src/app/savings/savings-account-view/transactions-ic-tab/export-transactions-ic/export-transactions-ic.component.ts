 ...
 */
@Component({
  selector: 'mifosx-export-transactions-ic',
  templateUrl: './export-transactions-ic.component.html',
  styleUrls: ['./export-transactions-ic.component.scss']
})
export class ExportTransactionsIcComponent implements OnInit {
  ...
  generate() {
    ...
    this.reportsService.getPentahoRunReportData('Client Saving Transactions', data, 'default', 'en', 'dd/MM/yyyy')
      .subscribe( (res: any) => {
