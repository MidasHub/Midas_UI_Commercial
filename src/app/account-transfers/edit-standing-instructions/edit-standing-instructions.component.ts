...
export class EditStandingInstructionsComponent implements OnInit {
  ...
  editStandingInstructionsForm: FormGroup = new FormGroup({});
  /** Priority Type Data */
  ...
  submit() {
    ...
    const standingInstructionData = {
      ...
      recurrenceOnMonthDay: this.datePipe.transform(this.editStandingInstructionsForm.value.recurrenceOnMonthDay, 'dd/MM'),
